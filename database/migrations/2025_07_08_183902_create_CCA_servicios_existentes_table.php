...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('CCA_servicios_existentes', function (Blueprint $table) {
            ...
            $table->foreignId('clasificacion_id')->constrained('CCA_servicios_clasificaciones', 'id_servicio_clasificacion')->cascadeOnUpdate()->cascadeOnDelete();
            ...
            $table->foreignId('estado_id')->constrained('CCA_servicios_estados', 'id_servicio_estado')->cascadeOnUpdate()->cascadeOnDelete();
            ...
            $table->boolean('falsa_alarma')->default(0);
