...
@section('subtitle', 'Hidraulico - Ver Compañia')
@section('content_header_title', 'Hidraulico - Ver Compañia')
...
@section('content_body')
    ...
    @livewire('materiales.equipo-hidraulico.ver-compania',['compania_id' => $compania ])
