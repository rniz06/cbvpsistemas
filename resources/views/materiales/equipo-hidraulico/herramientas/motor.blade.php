...
@section('subtitle', 'H. Herramientas - Motor')
@section('content_header_title', 'Hidraulico - Herramientas - Motor')
...
@section('content_body')
    ...
    @livewire('materiales.equipo-hidraulico.herramientas.motor')
