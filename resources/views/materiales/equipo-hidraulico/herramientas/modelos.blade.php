...
@section('subtitle', 'E. Hidraulico - Modelos')
@section('content_header_title', 'E. Hidraulico - Modelos')
...
@section('content_body')
    ...
    @livewire('materiales.equipo-hidraulico.herramientas.modelos',['marca_id' => $marca])
