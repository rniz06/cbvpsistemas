<div class="row">
    ...
    <h4>Ficha de Equipo Forestal</h4>
    ...
    @if ($ver_form_alta)
        <br>
        <div class="col-md-12">
            @livewire('materiales.menor.forestales.edit', ['item' => $item->id_menor_item])
        </div>
    @endif
        ...
        <x-table.tabla titulo="Comentarios" dropdown_direccion="dropleft" paginado="paginado">
            ...
            @can('Material Menor Editar')
                <x-slot name="acciones">
                    <x-adminlte-button :label="$ver_form_alta ? 'Cerrar Formulario' : 'Actualizar'" class="btn-sm dropdown-item" :icon="$ver_form_alta ? 'fas fa-times' : 'fas fa-edit'"
