<div class="row">
    ...
    @if ($ver_form_alta)
        <br>
        <div class="col-md-12">
            @livewire('materiales.menor.forestales.create', ['companiaId' => $compania->id_compania])
        </div>
    @endif
    ...
    {{-- ITEMS --}}
    <div class="col-md-12">
        <x-table.tabla titulo="Equipos Forestales" dropdown_direccion="dropleft" paginado="paginado">
