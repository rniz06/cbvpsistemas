<div>
        ...
        @if ($componente)
            @livewire(
                ...
                [
                    ...
                    'routeToRedirect' => 'materiales.menor.componentes.index-forestales',
                    'categoriaId' => \App\Enums\Materiales\Menor\CategoriaComponente::EQUIPOS_FORESTALES,
                ],
    ...
    <x-table.tabla titulo="Lista de Componentes - Equipos Forestales" pdf="exportar('pdf')" excel="exportar('excel')"
        ...
        @can('Materiales Menor Componentes Crear')
            ...
            @livewire('materiales.menor.componentes.modal-create', ['routeToRedirect' => 'materiales.menor.componentes.index-forestales', 'categoriaId' => \App\Enums\Materiales\Menor\CategoriaComponente::EQUIPOS_FORESTALES])
        @endcan
