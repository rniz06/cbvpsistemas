<div>
    ...
    <!-- Tabla -->
    <x-tabla titulo="Parametros - Equipo Hidraulico - Herramientas - Marcas">
        ...
        @foreach ($marcas as $marca)
            <tr wire:click="seleccionado({{ $marca->idhidraulico_herr_marca }})" wire:key="{{ $marca->idhidraulico_herr_marca }}">
                <td>{{ $marca->marca ?? 'N/A' }}</td>
                <td>
                    <a href="{{ route('materiales.hidraulico.herramientas.modelos', $marca->idhidraulico_herr_marca) }}" class="btn btn-block btn-outline-success btn-sm">Ver Modelos</a>
                </td>
