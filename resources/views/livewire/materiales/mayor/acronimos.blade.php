<div>
    ...
    @canany([
        ...
        <x-card-form>
            ...
            <x-slot name="buttons">
                @can('Material Mayor Acronimos Crear')
                ...
                @can('Material Mayor Acronimos Editar')
                ...
                @can('Material Mayor Acronimos Eliminar')
                ...
                @canany(['Material Mayor Acronimos Crear', 'Material Mayor Acronimos Editar'])
