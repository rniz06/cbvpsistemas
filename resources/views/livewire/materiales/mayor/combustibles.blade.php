<div>
    ...
    <x-tabla titulo="Parametros - Combustibles">
        ...
        @foreach ($combustibles as $combustible)
            <tr wire:click="seleccionado({{ $combustible->id_movil_combustible }})"
                wire:key="{{ $combustible->id_movil_combustible }}">
                <td>{{ $combustible->tipo ?? 'N/A' }}</td>
                <td>{{ $combustible->activo ? 'Activo' : 'Inactivo' }}</td>
                <td>
                    <button class="btn btn-sm" style="border:none;background:transparent;"
                        wire:click="cambiarEstado({{ $combustible->id_movil_combustible }}, true)"
                    ...
                    <button class="btn btn-sm" style="border:none;background:transparent;"
                        wire:click="cambiarEstado({{ $combustible->id_movil_combustible }}, false)"
