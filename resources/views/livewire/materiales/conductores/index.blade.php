<div>
    ...
    <x-tabla titulo="Listado de Conductores" excel pdf>
        ...
        <x-slot name="cabeceras">
            <th><x-adminlte-input name="" wire:model.live.debounce.200ms="buscarCodigo" label="Codigo:" /></th>
            <th><x-adminlte-input name="" wire:model.live.debounce.200ms="buscarNombrecompleto"
                    label="Nombre Completo:" /></th>
            <th><x-adminlte-select name="" wire:model.live.debounce.200ms="buscarCompaniaId" label="Compañia:">
            ...
            <th><x-adminlte-select name="" wire:model.live.debounce.200ms="buscarEstadoId" label="Estado:">
                    <option value="">-- TODOS --</option>
            ...
            <th><x-adminlte-select name="" wire:model.live.debounce.200ms="buscarClaseLicenciaId"
