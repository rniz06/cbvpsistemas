                        ...
                        @foreach ($modulos as $modulo)
                            <div class="card">
                                <div class="card-header p-2" id="heading{{ $modulo->id_sys_modulo }}">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link font-weight-bold text-dark" type="button" data-toggle="collapse"
                                            data-target="#collapse{{ $modulo->id_sys_modulo }}" aria-expanded="true"
                                            aria-controls="collapse{{ $modulo->id_sys_modulo }}">
                                            {{ $modulo->modulo }}
                                        </button>
                                    </h5>
                                </div>
