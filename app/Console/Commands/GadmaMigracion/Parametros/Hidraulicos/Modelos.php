...
class Modelos extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gadma-migracion:hidraulicos-modelos';
    ...
    {
        $this->info("Iniciando importación de MAT_hidraulicos_modelos...");

        // Obtener todos los registros de móviles de la tabla origen
        $registros = DB::table('materialescbvp.hidraulicos_modelos')->get();

        foreach ($registros as $registro) {
            DB::table('personalcbvp.MAT_hidraulicos_modelos')->insert([
