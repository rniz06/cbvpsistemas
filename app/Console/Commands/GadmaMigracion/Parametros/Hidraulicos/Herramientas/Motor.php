...
class Motor extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gadma-migracion:hidraulicos-herramientas-motor';
    ...
    {
        $this->info("Iniciando importación de MAT_hidraulicos_herr_motor...");

        // Obtener todos los registros de móviles de la tabla origen
        $registros = DB::table('materialescbvp.hidraulicos_herr_motor')->get();

        foreach ($registros as $registro) {
            DB::table('personalcbvp.MAT_hidraulicos_herr_motor')->insert([
