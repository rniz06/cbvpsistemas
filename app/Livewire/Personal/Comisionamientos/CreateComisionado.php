...
class CreateComisionado extends Component
{
    ...
    public $cargo_id, $compania_id, $direccion_id, $fecha_inicio, $codigo_comisionamiento; // Datos generales
    ...
    public function mount()
    {
        ...
        $this->cargos          = Cargo::select('id_cargo', 'cargo')->whereNull('codigo_cargo')->get();
    ...
    protected function rules()
    {
        return [
            ...
            'codigo'                 => [
                ...
                'min_digits:1',
                'max_digits:5',
                // Valida que el codigo existen en la categoria ingresada
            ...
            'codigo_comisionamiento' => ['required', Rule::unique(Comisionamiento::class, 'codigo_comisionamiento')
                ->where(
                    fn($query) => $query
                        ->where('tipo_id', 2)
                        ->where('culminado', false)
                )], // VALIDA SI EXISTE ALGUN COMISIONAMIENTO ACTIVO CON ESE CODIGO
        ];
    }
    ...
    public function guardar()
    {
        ...
        Comisionamiento::create([
            'tipo_id'                => Comisionamiento::TIPO_COMISIONADO, // Constante definida en el modelo
            ...
            'codigo_comisionamiento' => $this->codigo_comisionamiento,
            'creadoPor'              => Auth::id()
        ]);
    ...
    {
        return view('livewire.personal.comisionamientos.create-comisionado');
    }
}
