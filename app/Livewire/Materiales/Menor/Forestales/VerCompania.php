...
class VerCompania extends Component
{
    /*
    |------------------------------------------------------
    | RENDERIZA VISTA DE UNA COMPANIA CON LISTA DE FORESTAL
    |------------------------------------------------------
    */
    ...
    {
        return view('livewire.materiales.menor.forestales.ver-compania', [
    ...
    public function queryBase()
    {
        return Item::select('id_menor_item', 'componente_id', 'cantidad_operativo', 'cantidad_inoperativo')
            ...
            ->whereRelation('componente', 'categoria_id', CategoriaComponente::EQUIPOS_FORESTALES);
    }
