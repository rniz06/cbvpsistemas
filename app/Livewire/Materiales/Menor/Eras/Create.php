...
class Create extends Component
{
    ...
    / EN materiales.menor.eras.ver-compania
    |------------------------------------------------------
    */
    ...
    protected function rules()
    {
        return [
            ...
            'marca_id'  => [
                ...
                Rule::unique(Item::class, 'marca_id')->where('compania_id', $this->compania_id)
            ],
    ...
    public function guardar()
    {
        ...
        return redirect()->route('materiales.menor.eras.ver-compania', $this->compania_id);
    }
