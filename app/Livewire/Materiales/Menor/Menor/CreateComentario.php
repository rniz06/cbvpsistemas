...
class CreateComentario extends Component
{
    /*
    |------------------------------------------------------
    | RENDERIZA FORM DE ALTA DE COMENTARIO PARA MATERIAL MENOR
    / EN materiales.menor.ver-ficha
    |------------------------------------------------------
    */
    ...
    public function guardar(AplicarAccionItem $action)
    {
        ...
        return redirect()->route('materiales.menor.ver-ficha', $this->item->id_menor_item);
    }

    public function render()
    {
        return view('livewire.materiales.menor.menor.create-comentario');
    }
}
