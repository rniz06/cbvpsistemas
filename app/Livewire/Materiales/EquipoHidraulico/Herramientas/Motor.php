...
class Motor extends Component
{
    ...
    {
        if ($this->motor_id) {
            HerramientaMotor::destroy($this->motor_id);
            $this->resetearForm();
        }
    }
    ...
    public function grabar()
    {
        ...
        if ($this->modo === 'agregar') {
            HerramientaMotor::create($validados);
        } elseif ($this->modo === 'modificar' && $this->motor_id) {
            HerramientaMotor::findOrFail($this->motor_id)->update($validados);
        }
    ...
    {
        return view('livewire.materiales.equipo-hidraulico.herramientas.motor', [
            'motores' => HerramientaMotor::select('idhidraulico_herr_motor', 'motor')
